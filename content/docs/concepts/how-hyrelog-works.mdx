...
3. You query events with `GET /v1/events` (API) or use **Event Explorer** in the [dashboard](/dashboard/event-explorer) for interactive review.
4. Optional: HyreLog pushes matching events to your webhook endpoint.
5. Optional: You create export jobs to download data at scale (API or [dashboard exports](/dashboard/exports)).
